...
public class ResultsPanel extends JPanel implements ActionListener {
    ...
    public ResultsPanel(int width, int height, PlaySpace playSpace) {
        ...
        JLabel heading = new JLabel("Výsledky");
        ...
        JPanel scoreLabelContainer = new JPanel();
        scoreLabelContainer.setOpaque(false);
        scoreLabel = new JLabel("Skóre:");
        scoreLabelContainer.add(scoreLabel);
        resultsContainer.add(scoreLabelContainer);
        JPanel linesLabelContainer = new JPanel();
        linesLabelContainer.setOpaque(false);
        linesLabel = new JLabel("Řady:");
        linesLabelContainer.add(linesLabel);
        resultsContainer.add(linesLabelContainer);
        container.add(resultsContainer);
        
        JPanel buttonContainer = new JPanel();
        playButton = new JButton("  hrát znovu  ");
    ...
    public void setResults(int score, int lines) {
        scoreLabel.setText("Skóre: " + score);
        linesLabel.setText("Řady: " + lines);
    }
